...
const adoino = "/images/rasberrypi.svg";
...
const MarketDetail2 = () => {
  ...
  // 더미 데이터 (추후 API 연동 가능)
  const product = {
    name: "라즈베리파이 5 raspberry pi 5 model 8gb ",
    desc: "라즈베리파이 5 raspberry pi 5 model 8gb",
    price: 119500,
    shipping: "무료",
    type: "새 제품",
    point: 80,
    img: "/images/rasberrypi.svg", // 실제 이미지 경로 넣으시면 됩니다
  };
